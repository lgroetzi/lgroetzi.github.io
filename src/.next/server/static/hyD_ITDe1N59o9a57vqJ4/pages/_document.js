...
class CustomDocument extends next_document__WEBPACK_IMPORTED_MODULE_0___default.a {
  render() {
    return __jsx("html", {
      lang: "en"
    }, __jsx(next_document__WEBPACK_IMPORTED_MODULE_0__["Head"], null, __jsx("link", {
      rel: "preconnect",
      ...
      rel: "preload",
      as: "style",
      href: "https://fonts.googleapis.com/css2?family=Cabin:wght@700&family=Open+Sans&family=Open+Sans:wght@700&display=swap"
    }), __jsx("link", {
      rel: "stylesheet",
      href: "https://fonts.googleapis.com/css2?family=Cabin:wght@700&family=Open+Sans&family=Open+Sans:wght@700&display=swap",
